...
class EasySVG
{
    ...
    public function textDef(string $text): string
    {
        ...
        foreach ($textUnicode as $letter) {
            ...
            echo "".count($this->font->glyphs)."<br>".$letter."<br>";
...
// $text = "S";
// $svg = new EasySVG();
// $svg->addAttribute("width", "200px");
// $svg->addAttribute("height", "200px");
// $svg->addAttribute("style", "border: dashed 1px #aaa");
// $svg->setFontSVG("Bangkok.svg");
// $svg->setFontSize(80);
// $svg->setFontColor('#000000');
// $svg->setLetterSpacing(.1);
// $svg->setUseKerning(true);
// $svg->addText($text, "center", "center");
// $b64 = base64_encode($svg->asXML());
// echo "<div  style=\"background-image: url(data:image/svg+xml;base64,$b64); width : 100px; height :100px \">
//         </div>";
// ?>
